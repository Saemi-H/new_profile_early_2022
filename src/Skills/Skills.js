  ...
  return (
    ...
    <FrontItem>
                    ...
                    <StyledContent>
                        ...
                        <StyledLevel><Rate allowHalf disabled defaultValue={5} style={{listStyle: "none", display: "flex", marginTop: "-2.5rem"}}/></StyledLevel>
                    </StyledContent>
                </FrontItem>
                <FrontItem>
                    <StyledImgContainer>
                ...
                <FrontItem>
                    ...
                    <StyledLevel><Rate allowHalf disabled defaultValue={3.5} style={{listStyle: "none", display: "flex", marginTop: "-2.5rem"}}/></StyledLevel>
                    </StyledContent>
                </FrontItem>
                <FrontItem>
                    <StyledImgContainer>
                    ...
                    <StyledLevel><Rate allowHalf disabled defaultValue={4} style={{listStyle: "none", display: "flex", marginTop: "-2.5rem"}}/></StyledLevel>
                    </StyledContent>
                </FrontItem>
                <FrontItem>
                    <StyledImgContainer>
                    ...
                    <StyledLevel><Rate allowHalf disabled defaultValue={3} style={{listStyle: "none", display: "flex", marginTop: "-2.5rem"}}/></StyledLevel>
                    </StyledContent>
                </FrontItem>
                <FrontItem>
                    <StyledImgContainer>
    ...
    <Slider {...settings2} >
            ...
            <FrontItem>
            <StyledComImgContainer>
                    <img style={{margin: "0 auto", height: "50%"}} src={Jira} alt="jira logo" /> 
                    </StyledComImgContainer>
                    <StyledContent className='etc'>
            ...
            <FrontItem>
            <StyledComImgContainer>
                    <img style={{margin: "0 auto", height: "35%"}} src={confluence} alt="confluence logo" /> 
                    </StyledComImgContainer>
                    <StyledContent className='etc'>
